...
-(NSString *)calcRSA:(NSString *)pin{
    ...
    NSMutableData *myData = [[NSMutableData alloc] initWithCapacity:256];
    dataExchange = myData.mutableBytes;
    
    Ascii2Hex(dataExchange, (unsigned char *)[[block uppercaseString] UTF8String], (int)( [block length]));
    
    RSA_public_encrypt(256, dataExchange, OutBuff, EncryptRsa, RSA_NO_PADDING); // 加密
    ...
    return [self char2StringWithLength:OutBuff Length:256];
}
...
-(NSString *)ToRSADataWithPIN:(NSString *)pin{
    ...
    NSString *randomSyting = [self getRandomString:(int)(512 - 6 - XOR.length)];
